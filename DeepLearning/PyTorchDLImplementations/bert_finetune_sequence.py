...
Saves finetuned classifier to outputs/bert_finetune_sequence.pt
"""
...
class ClsDataset(Dataset):
    """Label 1 if sentence contains king/queen else 0."""

    def __init__(self, sentences):
        self.sentences = sentences
        self.labels = [1 if ("king" in s or "queen" in s) else 0 for s in sentences]
...
def main():
    ...
    best = float("inf")
    best_path = os.path.join(OUT_DIR, "bert_finetune_sequence.pt")
